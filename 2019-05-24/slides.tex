...
% \begin{frame}
%   \frametitle{Hello!}
%   I'm a new PhD student in the LogSem group.
%   \bigskip

%   \begin{itemize}
%   \item This talk is nominally based on a recent paper.
%   \item Really though, I'd like to talk about the core idea behind the work.
%   \item Motivate some of the problems we think about in LogSem.
%   \end{itemize}
% \end{frame}
