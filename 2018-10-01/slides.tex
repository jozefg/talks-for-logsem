...
\newcommand{\var}[1]{\mathbf{x}_{\color{Black} #1}}
\newcommand{\emp}{()}
...
\begin{frame}
  ...
  \begin{mathpar}
    \inferrule{
      \isterm{\Gamma}{u}{A}\\
      \isterm{\Gamma.A}{t}{B}
    }{\eqterm{\Gamma}{\app{\color{Black}(\fmttm{\lambda t})}{u}}{\subst{t}{u}{0}}{\subst{B}{u}{0}}}\and
    \inferrule{
      \istype{\Gamma}{A}\\
      \isterm{\Gamma.A}{t}{B}
    }{\eqterm{\Gamma}{\lambda \color{\Black}(\app{\weaken{t}{1}}{\var{0}})}{t}{A \to B}}\and
    \inferrule{
      \isterm{\Gamma}{t}{\Unit}
