...
\begin{frame}
  ...
  \begin{mathpar}
    ...
    \inferrule{
      \istype{\Gamma}{T}
    }{\isterm{\Gamma.T}{\var{0}}{\apsubst{T}{\weaken{1}}}}
  \end{mathpar}
\end{frame}
...
\begin{frame}
  ...
  \begin{mathpar}
    \inferrule{
      \isterm{\Gamma}{\apsubst{\var{0}}{\weaken{n}}}{A}
    }{\isneutral{\Gamma}{\nevar{n}}{A}}\and
    \inferrule{
...
\begin{frame}
  ...
  \[
    ...
    \exists \fmttm{t'}.\ \left(\gphquonf{\cxtlen{\Gamma}}{\vnf{v}{A}}{t'}\right) \land \left(\eqterm{\Gamma}{t}{t'}{T}\right)
  \]
\end{frame}
